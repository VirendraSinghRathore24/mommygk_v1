...
const InstaVideoCard = ({url, imageUrl, title}) => {
  return (
    <div className='hover:scale-110 transition duration-300 ease-in'>
        ...
        <div className='relative w-[240px] bg-bgDark bg-opacity-80 rounded-lg overflow-hidden shadow-lg pointer-events-auto'>
            <LazyLoadImage className=' h-[240px]' src={imageUrl} loading='lazy' alt='img'></LazyLoadImage>
            <div className='absolute bottom-4 -right-2 h-8 w-[60px] font-semibold rounded-md text-white hover:scale-110 transition duration-300 ease-in'>
