...
function FoodCharts() {
  ...
  return (
    <div>
        <p className='text-md font-light py-3 px-5'><strong className='font-bold text-3xl leading-5 text-richblack-700 uppercase text-red-600'>Recipes By Age -</strong> </p>
