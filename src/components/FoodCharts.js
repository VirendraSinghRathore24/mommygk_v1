...
function FoodCharts() {
  ...
  return (
    <div>
        <p className='text-md font-light py-3 px-5'><strong className='font-bold text-2xl leading-5 text-richblack-700 uppercase text-blue-600 underline'>Recipes By Age -</strong> </p>
