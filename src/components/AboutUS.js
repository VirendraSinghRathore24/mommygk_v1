...
function AboutUS() {
  return (
    ...
    <div className='flex flex-wrap'>
        <div className='flex flex-col ml-10 p-5 lg:w-7/12 xs:w-screen items-center justify-evenly'>
            <p className='leading-10 text-xl font-light align-baseline text-justify'>Hello!!! Thanks for visiting my space and taking the time to read about me. I am Sanju from Rajasthan and I live in Bangalore. I am working in IT industry as a software engineer for 10 years. I am mother of Rudransh Rathore and during this time I found my passion! Yes it's cooking and clicking, and so this blog!
