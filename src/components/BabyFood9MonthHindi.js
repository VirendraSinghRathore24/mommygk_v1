...
function BabyFood9MonthHindi() {
 ...
 function fetchBlogsData(){
  ...
  return (
    <div className='mb-10'>
    <p className='p-2'><strong><Link to="/">Home</Link> </strong> / <strong><Link to="/babyfoodchartshindi">Food Charts</Link> </strong> / 9 Month Hindi</p>
         <div className='p-4'>
         <div className='flex flex-col items-center'>
            <h2>9 महीने के बेबी फ़ूड की हिंदी में PDF फाइल डाउनलोड करें : </h2>
            <div className='bg-blue-500 mt-10 px-4 py-1 font-semibold text-center rounded-lg text-white hover:scale-110 transition duration-300 ease-in'>
                <a 
                    href="/9 Month Baby Food Recipe Hindi.pdf"
                    download="9 Month Baby Food Recipe Hindi"
                    target="_blank"
                    rel="noreferrer"
                >
...
export default BabyFood9MonthHindi