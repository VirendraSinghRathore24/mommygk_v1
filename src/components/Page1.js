  ...
  return (
    ...
    <div className='mx-auto'>
        ...
        <div className=''>
            ...
            <div className='grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 2xl:grid-cols-4 place-items-center gap-y-10 gap-x-4 mb-10 mt-4'>
            {
