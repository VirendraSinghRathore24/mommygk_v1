  ...
  return (
    <div>
           ...
           <Link to="/">
            ...
            <nav className="flex  max-w-maxScreen">
              <ul className="hidden items-center gap-x-6 md:flex">
                ...
                <li><a className="py-5 flase text-lg leading-5 relative group flex gap-1 items-center" href="/infant">
                <span>Infant</span>
                </a></li>
       ...
       visible">
        ...
        <li className="text-center"><a class="text-xl leading-5" href="/infant">Infant</a></li>
