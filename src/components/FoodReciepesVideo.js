...
function FoodReciepesVideo() {
  ...
  return (
    <div>
        <p className='text-md font-light py-5 px-5 mt-2 text-center'><strong className='font-bold text-3xl leading-5 text-richblack-700 uppercase text-red-700 font-mono'>Recipe Videos</strong> </p>
